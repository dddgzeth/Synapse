...
export const translations = {
  en: {
    ...
    chat: {
      ...
      emptyCopy: "Synapse remembers your conversations and builds working context over time,\nsurfacing patterns and connections you may not have noticed.",
      cards: [
      ...
      deepDescription: "Use the dedicated deep research model to search Semantic Scholar + arXiv, then synthesize results with your memory context.",
  ...
  zh: {
    ...
    chat: {
      ...
      emptyCopy: "Synapse 记住你所有的对话，随时间积累工作上下文，\n在你没注意到的地方，悄悄发现规律与联系。",
      cards: [
      ...
      networkError: "网络错误",
      references: "参考来源",
      deepDescription: "使用专属深度研究模型，自动检索 Semantic Scholar + arXiv 学术数据库，结合你的记忆上下文综合分析。",
